...
class Dijkstra_Reactive(app_manager.RyuApp):
  ...
  def __init__(self, *args, **kwargs):
    ...
    super(Dijkstra_Reactive, self).__init__(*args, **kwargs)
  ...
  def install_path(self, p, ev, src_mac, dst_mac):
        ...
        for sw, in_port, out_port in p:
            ...
            #datapath=sw#switches[int(sw)-1]
            #print ("switches=",switches)
            #print (sw, " in_port=", in_port, " out_port=", out_port, "switch=",datapath)
  ...
  def _packet_in_handler(self, ev):
    ...
    if dst in mymac.keys():
      ...
      if p!=None:
        ...
        out_port = p[0][2]
        #reverse
        p = get_path(mymac[dst][0], mymac[src][0], mymac[dst][1], mymac[src][1])
        if p!=None:
          self.install_path(p, ev, dst, src)        
